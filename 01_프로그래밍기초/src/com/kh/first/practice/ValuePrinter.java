...
public class ValuePrinter {
	public void print() {
		// 1. 숫자 출력
		System.out.println(123);  // 정수 값 출력
		System.out.println(3.14); // 실수 값 출력
		
		// 2. 연산 결과 출력
		System.out.println(125 + 40);
		System.out.println(1.23-0.12); // 실수값 연산은 불완전하다. 오차가 생길 수 있다.
		System.out.printf("%.2f\n", (1.23 - 0.12)); // 소수 2 번째까지 반올림하여 출력
...
//		System.out.println((int)'1');
		...
		System.out.println("반갑습니다." + 123);      // "반갑습니다." + "123"
		System.out.println((40 + 125) + "반갑습니다."); // "더한값" + "반갑습니다"
