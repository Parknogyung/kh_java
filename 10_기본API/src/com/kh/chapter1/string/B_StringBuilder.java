...
public class B_StringBuilder {
	public void method1() {
		 ...
		 * StringBuilder의 기본 생성자에 정수값을 전달해주면 해당 크기 만큼의 버퍼가 생성된다.
		 * StringBuilder의 생성자에 문자열을 전달해주면 문자열 크기 + 16의 버퍼가 생성된다.
		 */
		StringBuilder sb = new StringBuilder();
		StringBuilder sb1 = new StringBuilder(30); // 30의 버퍼의 크기를 갖게 해줌
		StringBuilder sb2 = new StringBuilder("Hello"); // 문자를 만들게 되면 자동적으로 버퍼의 크기 늘어남
