...
//		LocalDate parse = LocalDate.parse("20220909", DateTimeFormatter.ofPattern("yyyyMMdd"));
		LocalDate parse = LocalDate.parse("20220909", DateTimeFormatter.BASIC_ISO_DATE); //20220909를 포맷으로 변경
