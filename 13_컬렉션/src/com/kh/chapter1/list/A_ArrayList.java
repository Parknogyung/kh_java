...
public class A_ArrayList {
	...
	public void method1() {
		...
		LocalDateTime now = (LocalDateTime)list.get(1); // Object 타입이기 때문에 형변환 필요
...
//		}
	...
	public void method2() {
		 ...
		 *  - 컬렉션에 저장된 객체를 꺼내서 사용할 때 매번 형 변환 하지 않아도 된다.
		 *  
		 *  리스트의 정렬
		...
		// 오름차순으로 리스트를 정렬
		// Comparable 인터페이스를 구현하고 있는 요소를 가지고 있는 리스트를 인자로 전달
...
//		System.out.println();
		...
		// 두 번째 인자는 리스트 내의 각 요소(객체)를 비교하는데 사용하게 될 Comparator 인터페이스에 구현 객체를 넘겨준다.
