...
public class C_For {
	 ...
	 *  		   조건식이 false이면 실행 코드를 수행하지 않고 반복을 빠져나온다.
	 *  - 증감식 : 반복문을 제어하는 변수의 값을 증감 시키는 구문으로 주로 초기식에서 제시한 변수를 가지고 
	 *  		   증감 연산자(++, --)를 사용한다. 
	 *  * 초기식, 조건식, 증감식은 생략이 가능하고, 모두 생략하면 무한 루프에 빠진다. (for(;;) : 무한 루프) 
	 */
...
//		System.out.println(10);
		...
		for (int i = 20; i > 15; i--) { // 20, 19, 18, 17, 16. 초기식에 여러개의 변수 선언 가능
...
//			sum += (i + 1);
	...
	public void method3() {
		...
		// Math.random() 호출 시 -> 0.0 ~ 0.999999 사이의 랜덤값을 발생 (0.0 <= 랜덤 값 < 1.0)
